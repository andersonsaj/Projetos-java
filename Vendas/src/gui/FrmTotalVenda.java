...
public class FrmTotalVenda extends javax.swing.JFrame {
    ...
    private void btnPesquisaProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisaProdutoActionPerformed
        try {
          ...
          String data_venda = sdf.format(dataInicial) + " %";
          System.out.print(data_venda);
          double total_venda = dao.retornaTotalVendaPorData(data_venda);
          
          txtTotal.setText(String.valueOf(String.format("%.2f",total_venda)));
        } catch (Exception e) {
